...
ggarrange( bp.IAA.C.shoot, bp.CK.C.shoot, bp.GA.C.shoot, bp.ABA.C.shoot, bp.JA.C.shoot, bp.SA.C.shoot, 
           labels = c("Indole-3-acetic acid", "    Cytokinin", "    Gibberellins", "Abscisic Acid", " Jasmonic acid", " Salicylic acid"),
           ncol = 3, nrow = 2,   font.label = list(size = 18, color = "black", face = "bold"))
...
ggsave("barchart_shoot_hormones_nolegend.pdf", plot = last_plot(),
...
bp.IAA.C.shoot.legend<-ggplot(data = IAA.summary2) +
  geom_bar(
    aes(
      y = IAA,
      x = FERTILIZATION,
